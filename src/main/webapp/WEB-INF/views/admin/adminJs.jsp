...
<!-- All Jquery -->
    ...
    <script src="../resources/adminAssets/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="../resources/adminAssets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
