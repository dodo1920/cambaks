...
function goPopup(){
	...
	var pop = window.open("/연습/popup2.html","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
...
function closeAddrBar() {
	$("#addrSearchBar").css("display", "none");
}
...
<iframe id="addrSearchBar" width="650" height="478" src="/user/addrSearch">
</iframe>
</form>
</body>
</html>