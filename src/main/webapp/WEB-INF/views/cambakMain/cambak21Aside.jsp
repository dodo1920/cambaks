					...
					<div class="profile">
						<div>
							...
							<div class="profileCategory">
								<ul>
									<li class="profileMenu1"><a href="SHW_accountInfo.html" class="profileMenu">회원 정보 수정</a></li>
					...
					<div id="sidebar" class="4u">
						<div class="sidebar">
							...
							<ul class="nav nav-pills nav-stacked">
								<li class="active"><a href="SHW_myCamping.html" id="categoryFont">마이캠핑</a></li>
								...
								<li><a href="KJM_userOut1.html" id="categoryFont">회원 탈퇴</a></li>
								</li>
							</ul>
						</div>
					</div>
