...
public class AdminBoardDTO {
	...
	public String toString() {
		return "AdminBoardDTO [board_no=" + board_no + ", member_id=" + member_id + ", board_title=" + board_title
				...
				+ ", board_isDelete=" + board_isDelete + ", board_replyCnt=" + board_replyCnt + ", CategoryLink="
				+ CategoryLink + "]";
	}
