...
public class PaymentInfoSave {
	...
	public String toString() {
		return "PaymentInfoSave [payment_no=" + payment_no + ", member_id=" + member_id + ", payInfo_no=" + payInfo_no
				+ ", destination_no=" + destination_no + ", buyProduct_no=" + buyProduct_no + ", payment_date="
				+ payment_date + ", payment_deliveryMsg=" + payment_deliveryMsg + "]";
	}
